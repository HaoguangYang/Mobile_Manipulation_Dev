...
SSH_AUTH_SOCK=0 ssh -o ConnectTimeout=20 -fNT -R $NODE_SSH_REMOTE_PORT:localhost:22 ubuntu@34.221.135.10
echo "Mapped local SSH port to 34.221.135.10:$NODE_SSH_REMOTE_PORT."
SSH_AUTH_SOCK=0 ssh -o ConnectTimeout=20 -fNT -R $NODE_VNC_REMOTE_PORT:localhost:5900 ubuntu@34.221.135.10
echo "Mapped local VNC port to 34.221.135.10:$NODE_VNC_REMOTE_PORT."
SSH_AUTH_SOCK=0 ssh -o ConnectTimeout=20 -fNT -R $NODE_HTTP_REMOTE_PORT:localhost:8080 ubuntu@34.221.135.10
